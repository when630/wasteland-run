...
const THEMES: Record<string, CardTheme> = {
  PHYSICAL_ATTACK: {
    ...
    artIcon: '⚔', artIconColor: '#ff4444',
    typeIcon: '⚔️', typeLabel: 'Physical Attack',
  ...
  SPECIAL_ATTACK: {
    ...
    artIcon: '✦', artIconColor: '#9b59b6',
    typeIcon: '✦', typeLabel: 'Special Attack',
  ...
  PHYSICAL_DEFENSE: {
    ...
    artIcon: '🛡', artIconColor: '#2980b9',
    typeIcon: '🛡', typeLabel: 'Physical Defense',
  ...
  SPECIAL_DEFENSE: {
    ...
    artIcon: '◈', artIconColor: '#1abc9c',
    typeIcon: '◈', typeLabel: 'Special Defense',
  ...
  UTILITY: {
    ...
    artIcon: '⟳', artIconColor: '#d4ac0d',
    typeIcon: '⟳', typeLabel: 'Utility',
...
const STATUS_THEME: CardTheme = {
  ...
  artIcon: '🔥', artIconColor: '#aa3344',
  typeIcon: '⚠', typeLabel: 'Status',
  insetGlow: 'rgba(107,34,51,0.1)',
};

function getTheme(type: CardType): CardTheme {
  if (type === 'STATUS_BURN') return { ...STATUS_THEME };
  if (type === 'STATUS_RADIATION') return { ...STATUS_THEME, artIcon: '☢', artIconColor: '#44aa44' };
      ...
      >
        ...
        <div className="cf-header">
          ...
          <div className="cf-cost-row">
            <div className="cf-cost-pill">
              <span className="cf-cost-icon">⚡</span>
        ...
        <div className="cf-art-area">
          <div className="cf-art-bg" style={{ background: theme.artBg }}>
            <span className="cf-art-icon">{theme.artIcon}</span>
          </div>
        </div>
        ...
        <div className="cf-type-badge">
          <span className="cf-type-icon">{theme.typeIcon}</span>
          <span className="cf-type-label">{theme.typeLabel}</span>
        </div>

        {/* Exhaust mark */}
        {card.isExhaust && <div className="cf-exhaust-mark">EX</div>}

        {/* Lock overlay */}
        {isLocked && <div className="cf-lock-overlay">🔒</div>}
      </div>
    </div>
  );
};
